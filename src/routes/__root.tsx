...
function RootComponent() {
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-background p-6 text-center animate-in fade-in duration-700" dir="ltr">
      ...
      <div className="mb-8 flex justify-center">
        <div className="rounded-full bg-destructive/10 p-6 ring-1 ring-destructive/20">
          <div className="h-20 w-20 flex items-center justify-center text-destructive animate-pulse text-6xl">
            ⚠️
          </div>
        </div>
      </div>
      ...
      <div className="mt-12">
        <button
          className="h-16 px-10 text-lg font-bold shadow-2xl shadow-destructive/20 transition-all hover:scale-105 active:scale-95 bg-destructive hover:bg-destructive/90 text-destructive-foreground rounded-xl flex items-center gap-2 mx-auto"
